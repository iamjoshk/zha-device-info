...
This repository provides device-specific information for ZHA (Zigbee Home Automation) devices in Home Assistant. It exposes user-selected entities that are otherwise not easily accessible in the Home Assistant UI.

The code for this repository should follow Home Assistant and Zipgy best practices. Entities created should not break rules for Home Assistant, Zipgy, or ZHA.

From https://github.com/zigpy/zha-device-handlers:
## Zigbee Concepts

**Clusters**: Functionhttps://github.com/zigpy/zha-device-handlersality groupings containing attributes and commands.
